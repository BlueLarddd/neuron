...
class MyApp(App):
    def __init__(self, **kwargs):
        ...
        self.path = "../../Downloads/Telegram Desktop/plate_detector_new/default_image.jpg"
        self.plate_label = Label(text="", size_hint=(None, None))
        self.db_connection = sqlite3.connect("../../Downloads/Telegram Desktop/plate_detector_new/plates.db")
        self.create_table()
    ...
    def answer_button_pressed(self, *args):
        ...
        new_path = '../../Downloads/Telegram Desktop/plate_detector_new/corrected_plate.jpg'
        image_path = self.path
        first_path = '../../Downloads/Telegram Desktop/plate_detector_new/first_part'
        second_path = '../../Downloads/Telegram Desktop/plate_detector_new/second_part'
        weights_path = '../../Downloads/Telegram Desktop/plate_detector_new/weights.pth'
